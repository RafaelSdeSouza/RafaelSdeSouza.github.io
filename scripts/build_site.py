...
def main():
    ...
    for script in ("validate_content.py", "render_static_content.py", "check_publications.py", "check_writing.py", "check_site.py", "check_release_assets.py"):
        command = [sys.executable, str(ROOT / "scripts" / script)]
        if script == "render_static_content.py":
