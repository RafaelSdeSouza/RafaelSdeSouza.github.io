...
<div class="slot object-copy" style="--col:6;--span:5;--tcol:6;--tspan:3;--mcol:1;--mspan:4"><p>{esc(book["authors"])}</p><p class="citation">{esc(book["citation"]).replace(chr(10), '<br>')}</p><div class="actions">{''.join(f'<a href="{esc(item["url"])}">{esc(item["label"].format(publication_count=publication_count))}</a>' for item in book["links"])}</div></div>
    ...
    parts.append(f'''<section class="object-section grid elsewhere-section"><h2 class="slot label" style="--col:1;--span:2;--tcol:1;--tspan:1;--mcol:1;--mspan:4">Elsewhere</h2><div class="slot" style="--col:3;--span:6;--tcol:2;--tspan:6;--mcol:1;--mspan:4"><p>{esc(elsewhere["body"])}</p><p class="caption"><a href="{esc(elsewhere["url"])}">{esc(elsewhere["citation"])}</a></p></div></section>''')
