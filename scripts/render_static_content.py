...
<div class="slot object-copy" style="--col:6;--span:5;--tcol:6;--tspan:3;--mcol:1;--mspan:4"><p>{esc(book["authors"])}</p><p class="citation">{esc(book["citation"]).replace(chr(10), '<br>')}</p><div class="actions">{''.join(f'<a href="{esc(item["url"])}">{esc(item["label"].format(publication_count=publication_count))}</a>' for item in book["links"])}</div></div>
    ...
    coin = data["coin"]
    parts.append(f'''<section class="object-section grid coin-section"><h2 class="slot label" style="--col:1;--span:2;--tcol:1;--tspan:1;--mcol:1;--mspan:4">{esc(coin["label"])}</h2><div class="slot" style="--col:3;--span:5;--tcol:2;--tspan:4;--mcol:1;--mspan:4"><p>{esc(coin["body"])}</p><p class="link-line"><a href="{esc(coin["url"])}">Cosmostatistics Initiative</a></p></div><figure class="slot" style="--col:9;--span:3;--tcol:6;--tspan:3;--mcol:1;--mspan:4" data-role="documentary"><img src="assets/images/coin-2024.png" alt="Official Cosmostatistics Initiative COIN mark"></figure></section>''')
    ...
    parts.append(f'''<section class="object-section grid writing-section"><h2 class="slot label" style="--col:1;--span:2;--tcol:1;--tspan:1;--mcol:1;--mspan:4">Writing</h2><div class="slot" style="--col:3;--span:6;--tcol:2;--tspan:5;--mcol:1;--mspan:4"><blockquote class="literary-excerpt">{esc(work["excerpt"]).replace(chr(10), '<br>')}</blockquote><p class="caption"><cite>{esc(work["title"])}</cite><br>{esc(authors)}</p></div><figure class="slot" style="--col:10;--span:2;--tcol:7;--tspan:2;--mcol:1;--mspan:2" data-role="documentary"><img src="{esc(work["cover"])}" alt="{esc(work["cover_alt"])}"></figure></section>''')
    elsewhere = data["elsewhere"]
    parts.append(f'''<section class="object-section grid elsewhere-section"><h2 class="slot label" style="--col:1;--span:2;--tcol:1;--tspan:1;--mcol:1;--mspan:4">{esc(elsewhere["label"])}</h2><div class="slot" style="--col:3;--span:6;--tcol:2;--tspan:6;--mcol:1;--mspan:4"><p>{esc(elsewhere["body"])}</p><p class="caption"><a href="{esc(elsewhere["url"])}">{esc(elsewhere["citation"])}</a></p></div></section>''')
