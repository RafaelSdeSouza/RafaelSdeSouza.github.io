...
icon: software
tag: Software
summary: Research code designed to make statistical ideas testable, reusable, and inspectable.
...
icon: community
tag: COIN
summary: International projects that connect astronomy, statistics, machine learning, and scientific software.
...
imageFit: 
alt: Milky Way structure visual
...
imageFit: 
alt: Spectral classification graph visual
tag: Spectra
...
imageFit: 
alt: Cosmic structure map visual
tag: Weak lensing
...
### COIN: collaborative astrostatistics at scale.

eyebrow: Community
summary: I founded and co-chair the Cosmostatistics Initiative, an international network connecting astronomers, statisticians, computer scientists, and software developers around methodological problems in astrophysics.
url: coin.html
