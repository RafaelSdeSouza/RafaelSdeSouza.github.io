...
|---|---|---|---|---|
| Nebula contour field | Homepage hero | Original-site artistic imagery | `assets/images/backgrounds/home-nebula-contours.jpg`; repository-native artwork predating this redesign. Creator and rights metadata are not encoded in the repository. | **Keep provisionally** as personal identity, never as scientific evidence. Confirm ownership or reuse rights before launch. No new astronomical artwork is generated. |
